...
urlpatterns = [
    ...
    re_path(r'^task_edit/(?P<task_id>\d+)/$', views.task_edit, name='task_edit'),
    re_path(r'^task_delete/(?P<task_id>\d+)/$', views.task_delete, name='task_delete'),
    re_path(r'^new/$', views.new_task, name='new_task'),
]
